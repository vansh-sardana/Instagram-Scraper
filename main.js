...
function getTimestamp() {
    ...
    console.log(targetDate.customFormat("#DD#/#MM#/#YYYY# #hh#:#mm#:#ss#"));
...
client.on('ready', async () => {
    ...
    await delay(3000);
    await delete_file();
    familyMembers = ["kareenakapoorkhan", "priyankachopra", "nargisfakhri", "kajol", "bipashabasu", "kiaraaliaadvani", "officialraveenatandon", "theshilpashetty", "taapsee"]
    await downloadRecentPostsForFamilyMembers(familyMembers);
